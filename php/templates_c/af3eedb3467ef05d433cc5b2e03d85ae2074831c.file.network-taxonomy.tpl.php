<?php /* Smarty version Smarty-3.1.13, created on 2014-07-12 22:23:24
         compiled from "./templates/network-taxonomy.tpl" */ ?>
<?php /*%%SmartyHeaderCode:186248162053c1df8c817587-54801706%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af3eedb3467ef05d433cc5b2e03d85ae2074831c' => 
    array (
      0 => './templates/network-taxonomy.tpl',
      1 => 1393166245,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '186248162053c1df8c817587-54801706',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53c1df8d3ac925_41561947',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53c1df8d3ac925_41561947')) {function content_53c1df8d3ac925_41561947($_smarty_tpl) {?><!doctype html>
<html>
<head>
...
<div class="paper_info">
	...
	<h4 class="paper_content">
		<?php if ($_smarty_tpl->tpl_vars['paper']->value[0]['network_rating']==1){?>
			<input name="star1" type="radio" class="star" value="1" checked/> 
		<?php }else{ ?>
			<input name="star1" type="radio" class="star" value="1"/>
		<?php }?>

		<?php if ($_smarty_tpl->tpl_vars['paper']->value[0]['network_rating']==2){?>
            <input name="star1" type="radio" class="star" value="2" checked/> 
        <?php }else{ ?>
            <input name="star1" type="radio" class="star" value="2"/>
		<?php }?>

		<?php if ($_smarty_tpl->tpl_vars['paper']->value[0]['network_rating']==3){?>
            <input name="star1" type="radio" class="star" value="3" checked/> 
        <?php }else{ ?>
            <input name="star1" type="radio" class="star" value="3"/>
		<?php }?>

		<?php if ($_smarty_tpl->tpl_vars['paper']->value[0]['network_rating']==4){?>
            <input name="star1" type="radio" class="star" value="4" checked/> 
        <?php }else{ ?>
            <input name="star1" type="radio" class="star" value="4"/>
		<?php }?>

		<?php if ($_smarty_tpl->tpl_vars['paper']->value[0]['network_rating']==5){?>
...
<?php echo $_smarty_tpl->getSubTemplate ("paper_add_nm_comment.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

<?php echo $_smarty_tpl->getSubTemplate ("paper_add_nm_previous_comment.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
